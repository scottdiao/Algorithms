...
//if current grid value is W, this means previous stored value becomes invalid,
//you need to recalculate.

// during the iteration, we only need to calcaulate the first element of one row and store that
// value, then add it to col[j] which already calculated in the first row
